...
public final class EncryptedProperties2 {
    ...
    public EncryptedProperties2(File storageFile) {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            EncryptedProperties2 props = new EncryptedProperties2(file);
            ...
            props.changePassword("password".toCharArray(), "password2".toCharArray());
